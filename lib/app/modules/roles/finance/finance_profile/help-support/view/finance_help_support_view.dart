...
import '../../../../driver/profile/help_support/model/help_support_models.dart';
import '../controller/finance_help_support_controller.dart';

class FinanceHelpSupportView extends GetView<FinanceHelpSupportController> {
  const FinanceHelpSupportView({super.key});
      ...
      body: SafeArea(
        child: Obx(
          () => controller.isLoading.value && controller.quickHelpItems.isEmpty
              ? const Center(child: CircularProgressIndicator(color: kPurple,strokeWidth: 3,))
              : RefreshIndicator(
                  color: kPurple,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: FinanceHelpSupportView.kCardBg,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(color: FinanceHelpSupportView.kBorder),
        ),
        child: Column(
...
class _TicketCard extends StatelessWidget {
  ...
  static const Color kPurple = FinanceHelpSupportView.kPurple;
