...
import '../../live_map/views/live_map_view.dart';
import '../../reports/views/reports_view.dart';
import '../../notifications/views/notifications_tab_view.dart';
import '../../profile/views/profile_view.dart';

class FleetOpDashboardView extends GetView<FleetOpDashboardController> {
  const FleetOpDashboardView({super.key});
      ...
      body: SafeArea(
        child: Obx(() {
          switch (controller.selectedNavIndex.value) {
            ...
            case 3:
              return const NotificationsTabView();
            case 4:
